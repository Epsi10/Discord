...
module.exports = (() => {
    const config = {
		...
		"changelog": [
			{
				"title": "Added Streaming",
				"type": "added",
				"items": [
					"Unlocked 1080p 60fps Streaming."
					
				]
			},
			{
				"title": "Added GIF Emoji",
				"type": "added",
				"items": [
					"GIF Emoji Unlocked."
				]
        ...
        "main": "DiscordNitro.plugin.js"
    };

    return !global.SuperPluginLibrary ? class {
        constructor() {
            this._config = config;
        }
        getName() {
