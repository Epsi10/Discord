 ...
 * @source https://github.com/Marlodor96/Discord/releases/download/Discord/StreamUnlocker.plugin.js
 * @updateUrl https://github.com/Marlodor96/Discord/releases/download/Discord/StreamUnlocker.plugin.js
 */
/*@cc_on
@if (@_jscript)
...
module.exports = (() => {
    const config = {
        "info": {
            ...
            "version": "Latest",
            "description": "Unlock sharing your screen at 60fps 1080P everywhere!",
            "github": "https://github.com/Marlodor96/Discord/",
            "github_raw": "https://github.com/Marlodor96/Discord/releases/download/Discord/StreamUnlocker.plugin.js"
        },
		"changelog": [
			{
				"title": "Streaming Unlocker Permanently",
				"type": "added",
				"items": [
					"Unlocked Streaming in 1080p - 60fps."
				]
			}
			
		],
        "main": "StreamUnlocker.plugin.js"
    };
    ...
    return !global.ZeresPluginLibrary ? class {
        ...
        load() {
            BdApi.showConfirmationModal("Library Missing", `The library plugin needed for ${config.info.name} is missing. Please click Download Now to install it.`, {
                ...
                cancelText: "Cancel",
                onConfirm: () => {
                    require("request").get("https://github.com/Marlodor96/Discord/releases/download/Discord/0PluginLibrary.plugin.js", async (error, response, body) => {
                        if (error) return require("electron").shell.openExternal("https://github.com/Marlodor96/Discord/releases/download/Discord/0PluginLibrary.plugin.js");
        ...
        const plugin = (Plugin, Api) => {
            ...
            return class StreamUnlocker extends Plugin {
                defaultSettings = {
                    "screenSharing": false,
                };
